...
export function initBannerAdmin(): void {
    ...
    const linkLabel = document.getElementById(
        "banner-link-label",
    ) as HTMLInputElement | null;
    ...
    function renderPreview(): void {
        ...
        previewTitleEl.textContent =
            titleInput.value.trim() || "Nadpis bannera";
        previewMessageEl.textContent =
            messageInput.value.trim() || "Text bannera sa zobrazí tu.";
